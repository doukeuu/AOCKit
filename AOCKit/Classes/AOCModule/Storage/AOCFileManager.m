...
- (instancetype)initWithCachePath:(NSString *)cachePath config:(nonnull AOCFileConfig *)config {
    if (self = [super init]) {
...
- (void)removeExpiredData {
    ...
    switch (self.config.diskCacheExpireType) {
        case AOCFileConfigExpireTypeAccessDate:
            cacheContentDateKey = NSURLContentAccessDateKey;
            break;
        case AOCFileConfigExpireTypeModificationDate:
            cacheContentDateKey = NSURLContentModificationDateKey;
            break;
        case AOCFileConfigExpireTypeCreationDate:
            cacheContentDateKey = NSURLCreationDateKey;
            break;
        case AOCFileConfigExpireTypeChangeDate:
