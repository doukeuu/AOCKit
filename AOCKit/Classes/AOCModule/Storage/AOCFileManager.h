 ...
 */
@property (nonatomic, strong, readonly, nonnull) AOCFileConfig *config;
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull AOCFileConfig *)config;
