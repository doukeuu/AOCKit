...
+ (void)routerHookAppDelegateMethod {
    ...
    [appDelegateCls
     ...
     usingBlock:^(id<AspectInfo> aspectInfo, id application, id url, id options) {
        ...
        [[AOCRouterManager sharedManager].router handleURL:url withCompletion:nil];
    } error:NULL];
    ...
    [appDelegateCls
     ...
     usingBlock:^(id<AspectInfo> aspectInfo, id application, id userActivity, id handler) {
        ...
        [[AOCRouterManager sharedManager].router handleUserActivity:userActivity withCompletion:nil];
    } error:NULL];
}
...
+ (void)handleRoutePath:(NSString *)path completion:(void (^)(BOOL, NSError * _Nullable))completion {
