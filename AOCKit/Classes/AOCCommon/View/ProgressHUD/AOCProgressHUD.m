...
#import "AOCProgressHUD.h"
#import "AOCToolsUI.h"
#import <MBProgressHUD/MBProgressHUD.h>

@implementation AOCProgressHUD

// 显示菊花提示视图
+ (void)showHUD {
    [self showHUDInView:[AOCToolsUI currentViewController].view];
}
...
// 隐藏菊花提示视图
+ (void)hideHUD {
    [MBProgressHUD hideHUDForView:[AOCToolsUI currentViewController].view animated:YES];
}
